...
$.getJSON("data.json", async function (info) {
    ...
    <div class="cs-blog-detail">
        ...
        <div class="cs-post-title">
            <div class="cs-author">
                <figure>
                    <a href="https://shuvo18103107.github.io/"><img width="32" height="32"
                            ...
                            src="../images/alifoot.png" alt=""></a>
                </figure>
                <div class="cs-text">
                    <a href="https://shuvo18103107.github.io/">Mohammad Ali
                        Shuvo</a>
                </div>
            </div>
            <div class="post-option">

                <span class="post-date"><i class="cs-color icon-calendar6"></i>Apr 23, 2021</a></span>
                <span class="post-comment"><a href="#"><i class="cs-color icon-chat6"></i>4 Comments</a></span>
            </div>
        </div>
